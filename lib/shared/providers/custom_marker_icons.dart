...
class CustomMarkerIcons extends ChangeNotifier {
  BitmapDescriptor? newCustomMarker;
  BitmapDescriptor? witnessCustomMarker;

  CustomMarkerIcons() {
    final markerGenerator = MarkerGenerator(48);
    ...
    markerGenerator
      ...
      Colors.white,
        ...
        .then((BitmapDescriptor markerIcon) {
      this.newCustomMarker = markerIcon;
      notifyListeners();
    });
    ...
    markerGenerator
      ...
      Colors.white,
        ...
        .then((BitmapDescriptor markerIcon) {
      this.witnessCustomMarker = markerIcon;
      notifyListeners();
    });
  }
}
